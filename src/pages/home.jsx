...
const HomePage = () => {
  return (
    <>
      ...
      <section className="bg-white mt-20 dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
          ...
          >
            ...
            <span className="text-sm font-medium">
              Products was launched! See what's new
            </span>
            <svg
